...
import { HelpPane } from '~/utils/command-panes/help.jsx'
import { HijackPane } from '~/utils/command-panes/hijack.jsx'
import { LogsPane } from '~/utils/command-panes/logs.jsx'
